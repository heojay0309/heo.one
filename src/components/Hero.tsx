    ...
    <div className="relative -z-10 flex h-full w-full select-none flex-row justify-start gap-[32px] overflow-x-clip bg-gradient-to-br text-white tablet:min-h-[100vh] tablet:flex-col tablet:gap-[64px]">
      <div className="relative mt-[80px] flex w-full flex-col items-center justify-center">
        ...
        >
          <Link
            href={"#ShineResumes"}
            className={`flex h-[48px] w-[48px] items-center justify-center rounded-full transition-transform duration-200 ${index === 0 ? "scale-150" : "scale-100"} bg-white bg-opacity-0 transition-transform hover:bg-opacity-5 active:bg-opacity-10`}
          >
            <Image
          ...
          <Link
            href={"#Preps"}
            className={`flex h-[48px] w-[48px] items-center justify-center rounded-full transition-transform duration-200 ${index === 1 ? "scale-150" : "scale-100"} bg-white bg-opacity-0 hover:bg-opacity-5 active:bg-opacity-10`}
          >
            <Image
          ...
          <Link
            href={"#Mustadd"}
            className={`flex h-[48px] w-[48px] items-center justify-center rounded-full bg-white bg-opacity-0 transition-transform duration-200 ${index === 2 ? "scale-150" : "scale-100"} hover:bg-opacity-5 active:bg-opacity-10`}
          >
            <Image
          ...
          <Link
            href={"#Giverr"}
            className={`flex h-[48px] w-[48px] items-center justify-center rounded-full bg-white bg-opacity-0 transition-transform duration-200 hover:bg-opacity-5 active:bg-opacity-10 ${index === 3 ? "scale-150" : "scale-100"} `}
          >
            <Image
